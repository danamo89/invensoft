...
public class PersonaServiceImpl implements IPersonaService {
    ...
    @Override
    public void exportarExcel(Persona persona, String ubicacion, String nombreArchivo) throws IOException {
        FileOutputStream out = new FileOutputStream(new File(ubicacion+"/"+nombreArchivo+".xlsx"));
