...
CREATE TABLE `familiares` (
  ...
  `ULTIMO_ANIO_CURSADO` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID_FAMILIAR`),
  KEY `FAMILIARES_ID_PERSONA_idx` (`ID_PERSONA`),
  KEY `FAMILIARES_ID_TIPO_IDENTIFICACION_idx` (`ID_TIPO_IDENTIFICACION`),
  CONSTRAINT `FAMILIARES_ID_PERSONA` FOREIGN KEY (`ID_PERSONA`) REFERENCES `personas` (`ID_PERSONA`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
INSERT INTO `familiares` VALUES (1,2,'Pepe perez','2016-10-02 00:00:00',1,'123123123','Hijo(a)','Terciario');
