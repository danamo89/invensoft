...
CREATE TABLE `grupos_preguntas` (
  ...
  KEY `GRUPOS_PREGUNTAS_ID_BLOQUE_idx` (`ID_BLOQUE`),
  CONSTRAINT `GRUPOS_PREGUNTAS_ID_BLOQUE` FOREIGN KEY (`ID_BLOQUE`) REFERENCES `bloques` (`ID_BLOQUE`) ON DELETE CASCADE ON UPDATE NO ACTION
