...
CREATE TABLE `educaciones_formales` (
  ...
  CONSTRAINT `EDUCACIONES_FORMALES_ID_PERSONA` FOREIGN KEY (`ID_PERSONA`) REFERENCES `personas` (`ID_PERSONA`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `educaciones_formales` VALUES (2,2,'Primario',0,'q','q');
...
-- Dump completed on 2016-10-12 22:38:16
